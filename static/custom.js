...
$(document).ready(function () {
  console.log("helllloodoosodosodosod world")
...
$(document).ready(function () {
  ...
  $(".show-small-img").click(function () {
    ...
    $(this)
      .css({ border: "solid 2px #5757FF", opacity: "1", padding: "0" })
      .siblings()
      .css({ border: "none", opacity: "1", padding: "0" })
    if ($("#small-img-roll").children().length > 4) {
      if (
        ...
        $("#small-img-roll").css(
          "left",
          -($("#small-img-roll").children().length - 4) * 106 + "px"
        )
      } else {
  ...
  $("#next-img").click(function () {
    ...
    if ($("#small-img-roll").children().length > 4) {
      if (
        ...
        $("#small-img-roll").css(
          "left",
          -($(".show-small-img[alt='now']").index() - 2) * 106 + "px"
        )
      } else if (
        $(".show-small-img[alt='now']").index() ==
        $("#small-img-roll").children().length - 1
